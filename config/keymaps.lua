...
map("n", "<A-h>", ":BufferPrevious<CR>", { noremap = true, silent = true, desc = "Previous Tab" })
map("n", "<A-l>", ":BufferNext<CR>", { noremap = true, silent = true, desc = "Next Tab" })
...
-- Terminal
map('n', '<leader>oth', ':ToggleTerm size=10 direction=horizontal<CR>', opts)
map('n', '<leader>otf', ':ToggleTerm size=10 direction=float<CR>', opts)
